...
import static qa.engineeric.store.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import qa.engineeric.store.config.Constants;
import qa.engineeric.store.domain.User;
import qa.engineeric.store.repository.AuthorityRepository;
import qa.engineeric.store.repository.UserRepository;
import qa.engineeric.store.security.AuthoritiesConstants;
import qa.engineeric.store.service.UserService;
import qa.engineeric.store.service.dto.AdminUserDTO;
import qa.engineeric.store.service.dto.PasswordChangeDTO;
import qa.engineeric.store.service.dto.UserDTO;
import qa.engineeric.store.web.rest.vm.KeyAndPasswordVM;
import qa.engineeric.store.web.rest.vm.ManagedUserVM;
