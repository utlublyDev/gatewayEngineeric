...
export const NotificationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayEngineericApp.notificationNotification.delete.question">
        <Translate contentKey="gatewayEngineericApp.notificationNotification.delete.question" interpolate={{ id: notificationEntity.id }}>
