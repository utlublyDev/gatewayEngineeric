  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayEngineericApp.notificationNotification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="gatewayEngineericApp.notificationNotification.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayEngineericApp.notificationNotification.userStoreOwnerId')}
                id="notification-userStoreOwnerId"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.notificationNotification.date')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.notificationNotification.details')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.notificationNotification.sentDate')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.notificationNotification.format')}
              ...
              >
                {notificationTypeValues.map(notificationType => (
                  <option value={notificationType} key={notificationType}>
                    {translate('gatewayEngineericApp.NotificationType.' + notificationType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('gatewayEngineericApp.notificationNotification.userId')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.notificationNotification.productId')}
