...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOREOWNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOREOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOREOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOREOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOREOWNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOREOWNER actions', async () => {
      const expectedActions = [
        {
