...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOREADVBANNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOREADVBANNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOREADVBANNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOREADVBANNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOREADVBANNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOREADVBANNER actions', async () => {
      const expectedActions = [
        {
