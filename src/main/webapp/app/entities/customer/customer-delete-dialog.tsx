...
export const CustomerDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayEngineericApp.customer.delete.question">
        <Translate contentKey="gatewayEngineericApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
