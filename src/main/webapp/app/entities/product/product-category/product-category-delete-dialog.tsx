...
export const ProductCategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayEngineericApp.productProductCategory.delete.question">
        <Translate contentKey="gatewayEngineericApp.productProductCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
