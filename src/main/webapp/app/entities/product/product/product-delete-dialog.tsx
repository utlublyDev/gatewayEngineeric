...
export const ProductDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayEngineericApp.productProduct.delete.question">
        <Translate contentKey="gatewayEngineericApp.productProduct.delete.question" interpolate={{ id: productEntity.id }}>
