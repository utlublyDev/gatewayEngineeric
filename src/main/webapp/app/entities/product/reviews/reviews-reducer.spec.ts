...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reviews.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVIEWS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REVIEWS actions', async () => {
      const expectedActions = [
        {
