  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayEngineericApp.productProductOrder.home.createOrEditLabel" data-cy="ProductOrderCreateUpdateHeading">
            <Translate contentKey="gatewayEngineericApp.productProductOrder.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayEngineericApp.productProductOrder.userStoreOwnerId')}
                id="product-order-userStoreOwnerId"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productProductOrder.userId')}
                id="product-order-userId"
                name="userId"
                data-cy="userId"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productProductOrder.placedDate')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productProductOrder.status')}
              ...
              >
                {orderStatusValues.map(orderStatus => (
                  <option value={orderStatus} key={orderStatus}>
                    {translate('gatewayEngineericApp.OrderStatus.' + orderStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('gatewayEngineericApp.productProductOrder.code')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productProductOrder.invoiceId')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productProductOrder.customer')}
