...
export const ProductOrderDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayEngineericApp.productProductOrder.delete.question">
        <Translate contentKey="gatewayEngineericApp.productProductOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
