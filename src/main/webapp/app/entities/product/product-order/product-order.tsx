  ...
  return (
    <div>
      <h2 id="product-order-heading" data-cy="ProductOrderHeading">
        <Translate contentKey="gatewayEngineericApp.productProductOrder.home.title">Product Orders</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayEngineericApp.productProductOrder.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayEngineericApp.productProductOrder.home.createLabel">Create new Product Order</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productOrderList && productOrderList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayEngineericApp.productProductOrder.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="gatewayEngineericApp.productProductOrder.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="gatewayEngineericApp.productProductOrder.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {productOrderList.map((productOrder, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{productOrder.userStoreOwnerId}</td>
                  <td>{productOrder.userId}</td>
                  <td>
                    {productOrder.placedDate ? <TextFormat type="date" value={productOrder.placedDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    <Translate contentKey={`gatewayEngineericApp.OrderStatus.${productOrder.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayEngineericApp.productProductOrder.home.notFound">No Product Orders found</Translate>
            </div>
          )
        )}
      </div>
