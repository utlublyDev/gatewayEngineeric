  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayEngineericApp.productOrderItem.home.createOrEditLabel" data-cy="OrderItemCreateUpdateHeading">
            <Translate contentKey="gatewayEngineericApp.productOrderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayEngineericApp.productOrderItem.userStoreOwnerId')}
                id="order-item-userStoreOwnerId"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productOrderItem.userId')}
                id="order-item-userId"
                name="userId"
                data-cy="userId"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productOrderItem.quantity')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productOrderItem.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productOrderItem.status')}
              ...
              >
                {orderItemStatusValues.map(orderItemStatus => (
                  <option value={orderItemStatus} key={orderItemStatus}>
                    {translate('gatewayEngineericApp.OrderItemStatus.' + orderItemStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('gatewayEngineericApp.productOrderItem.paymentId')}
                id="order-item-paymentId"
                name="paymentId"
                data-cy="paymentId"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.productOrderItem.orderNumber')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('gatewayEngineericApp.productOrderItem.product')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="order"
                data-cy="order"
                label={translate('gatewayEngineericApp.productOrderItem.order')}
                type="select"
                required
              >
                <option value="" key="0" />
