...
export const OrderItemDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayEngineericApp.productOrderItem.delete.question">
        <Translate contentKey="gatewayEngineericApp.productOrderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
