...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './top-banner-information.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPBANNERINFORMATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPBANNERINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPBANNERINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPBANNERINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPBANNERINFORMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPBANNERINFORMATION actions', async () => {
      const expectedActions = [
        {
