  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayEngineericApp.invoiceInvoice.home.createOrEditLabel" data-cy="InvoiceCreateUpdateHeading">
            <Translate contentKey="gatewayEngineericApp.invoiceInvoice.home.createOrEditLabel">Create or edit a Invoice</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceInvoice.userStoreOwnerId')}
                id="invoice-userStoreOwnerId"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceInvoice.userId')}
                id="invoice-userId"
                name="userId"
                data-cy="userId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceInvoice.code')}
                id="invoice-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceInvoice.date')}
                id="invoice-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceInvoice.details')}
                id="invoice-details"
                name="details"
                data-cy="details"
                type="text"
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceInvoice.status')}
                id="invoice-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {invoiceStatusValues.map(invoiceStatus => (
                  <option value={invoiceStatus} key={invoiceStatus}>
                    {translate('gatewayEngineericApp.InvoiceStatus.' + invoiceStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceInvoice.paymentMethod')}
              ...
              >
                {paymentMethodValues.map(paymentMethod => (
                  <option value={paymentMethod} key={paymentMethod}>
                    {translate('gatewayEngineericApp.PaymentMethod.' + paymentMethod)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceInvoice.paymentDate')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceInvoice.paymentAmount')}
