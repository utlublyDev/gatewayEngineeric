...
export const InvoiceDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayEngineericApp.invoiceInvoice.delete.question">
        <Translate contentKey="gatewayEngineericApp.invoiceInvoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
