...
export const ShipmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayEngineericApp.invoiceShipment.delete.question">
        <Translate contentKey="gatewayEngineericApp.invoiceShipment.delete.question" interpolate={{ id: shipmentEntity.id }}>
