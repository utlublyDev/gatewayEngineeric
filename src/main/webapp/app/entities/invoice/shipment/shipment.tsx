  ...
  return (
    <div>
      <h2 id="shipment-heading" data-cy="ShipmentHeading">
        <Translate contentKey="gatewayEngineericApp.invoiceShipment.home.title">Shipments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayEngineericApp.invoiceShipment.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayEngineericApp.invoiceShipment.home.createLabel">Create new Shipment</Translate>
          </Link>
        </div>
      </h2>
        ...
        {shipmentList && shipmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayEngineericApp.invoiceShipment.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('userId')}>
                  <Translate contentKey="gatewayEngineericApp.invoiceShipment.userId">User Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="gatewayEngineericApp.invoiceShipment.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('details')}>
                  <Translate contentKey="gatewayEngineericApp.invoiceShipment.details">Details</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="gatewayEngineericApp.invoiceShipment.invoice">Invoice</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {shipmentList.map((shipment, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{shipment.userStoreOwnerId}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayEngineericApp.invoiceShipment.home.notFound">No Shipments found</Translate>
            </div>
          )
        )}
      </div>
