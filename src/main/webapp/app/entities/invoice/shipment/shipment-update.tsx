  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayEngineericApp.invoiceShipment.home.createOrEditLabel" data-cy="ShipmentCreateUpdateHeading">
            <Translate contentKey="gatewayEngineericApp.invoiceShipment.home.createOrEditLabel">Create or edit a Shipment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceShipment.userStoreOwnerId')}
                id="shipment-userStoreOwnerId"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceShipment.userId')}
                id="shipment-userId"
                name="userId"
                data-cy="userId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceShipment.trackingCode')}
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceShipment.date')}
                id="shipment-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('gatewayEngineericApp.invoiceShipment.details')}
                id="shipment-details"
                name="details"
                data-cy="details"
                type="text"
              ...
              <ValidatedField
                ...
                name="invoice"
                data-cy="invoice"
                label={translate('gatewayEngineericApp.invoiceShipment.invoice')}
                type="select"
                required
              >
                <option value="" key="0" />
