...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './slider-image-slider.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SLIDERIMAGESLIDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SLIDERIMAGESLIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SLIDERIMAGESLIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SLIDERIMAGESLIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SLIDERIMAGESLIDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SLIDERIMAGESLIDER actions', async () => {
      const expectedActions = [
        {
