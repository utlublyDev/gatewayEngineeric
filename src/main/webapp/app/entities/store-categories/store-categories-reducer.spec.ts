...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORECATEGORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_STORECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STORECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STORECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STORECATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STORECATEGORIES actions', async () => {
      const expectedActions = [
        {
